...
import { sourceRu } from "@/lib/source-ru"
...
export async function generateMetadata(props: {
  ...
  const page = sourceRu.getPage(params.slug)
...
export default async function Page(props: {
  ...
  const doc = page.data
  const MDX = doc.body
  const neighbours = findNeighbour(sourceRu.pageTree, page.url)
